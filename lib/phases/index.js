...
const HERMES_DEFAULTS = {
  ...
  'topic-selection': { select_mode: 'single', enable_feedback: true },
  'outline-generation': { max_candidates: 3, include_visual_intent: true },
  ...
  'character-generation': { views: ['front', 'side', 'back'], model: 'flux-dev' },
  ...
  'consistency-guard': { face_threshold: 0.85, clothing_check: true },
  'cloud-production': { suppress_music: true, max_retries: 1, parallel_shots: 4 },
  'final-audio': { bgm_model: 'ace-step-xl', target_lufs: -14 },
  'delivery': { face_consistency_threshold: 0.90, lip_sync_threshold: 1, audio_lufs: -16 },

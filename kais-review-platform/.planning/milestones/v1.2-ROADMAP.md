...
- [x] **Phase 13: Cross-System Protocol Alignment** — Fix 4 broken cross-system contracts: callback payload disposition_action, auth token field name, HMAC header naming, pipeline.js CLI entry point (gap closure from v1.2 audit) (completed 2026-05-09)
- [x] **Phase 14: E2E Callback Verification** — Remove emit_state_change patch, verify real callback delivery end-to-end for gold-team and movie-agent (gap closure from v1.2 audit) (completed 2026-05-09)
...
Plans:
- [x] 13-01-PLAN.md — Review-platform contract fixes: add disposition_action to callback payload, align HMAC header naming (GT-04, MA-04, MA-05, MA-06)
- [x] 13-02-PLAN.md — External system contract fixes: review_check.py auth token field, pipeline.js CLI entry point (GT-01, MA-05)
...
Plans:
- [x] 14-01-PLAN.md — Fix E2E test fixtures, add callback delivery assertions, verify HMAC signatures for both systems
...
| 13. Cross-System Protocol Alignment | v1.2 | 2/2 | Complete   | 2026-05-09 |
| 14. E2E Callback Verification | v1.2 | 1/1 | Complete   | 2026-05-09 |

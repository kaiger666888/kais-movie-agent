...
- [ ] **GPU-DIRECT-02**: `plugins/kais_aigc/review_platform.py` 实现 ReviewPlatformClient — JWT bearer 认证 + POST `/api/v1/reviews` + GET `/api/v1/reviews/{id}` 状态轮询 + HMAC-SHA256 callback 验签 + 5min timestamp window

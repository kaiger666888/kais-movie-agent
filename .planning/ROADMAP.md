...
- [x] 41-03-PLAN.md — query_by_structure with cosine+jaccard similarity (0.7*cos + 0.3*jac, pure stdlib) — completes RECIPE-LIB-01 (5/5 methods) + RECIPE-LIB-05 (similarity query)
